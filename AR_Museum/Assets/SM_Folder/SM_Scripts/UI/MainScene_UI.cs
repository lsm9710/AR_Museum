...
public class MainScene_UI : MonoBehaviour
{
    ...
    public void Go_MarkerCameraScene()
    {
        ...
        if (wook_STAMP_Manager.instance != null)
        {
            wook_STAMP_Manager.instance.SuccessCount++;
            wook_STAMP_Manager.instance.ischecked = false;
        }
        SceneManager.LoadScene("Rally_MarkerCameraScene");
    }

    public void Go_GameScene()
    {
        SceneManager.LoadScene("Rally_GameScene");
    }

    public void Go_SelfCameraScene()
    {
        SceneManager.LoadScene("Rally_FaceARScene");
    }
