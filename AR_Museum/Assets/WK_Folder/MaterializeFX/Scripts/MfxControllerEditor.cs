...
namespace Assets.MaterializeFX.Scripts
{
    ...
    internal sealed class MfxControllerEditor : Editor
    {
        ...
        private static void ShowByDistanceUi(MfxController mfxController)
        {
            ...
            mfxController.IsWorldPositionOffsetEnabled = EditorGUILayout.Toggle(MfxEditorLocalization.WorldOffsetLabel, mfxController.IsWorldPositionOffsetEnabled);
        }
        ...
        private static class MfxEditorLocalization
        {
            ...
            public const string WorldOffsetLabel = "Use World Offset based on Target position";
